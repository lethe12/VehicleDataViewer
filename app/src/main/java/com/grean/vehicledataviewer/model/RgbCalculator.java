...
/**
 * Created by weifeng on 2020/5/12.
 */

public class RgbCalculator {
    private static final String tag = "RgbCalculator";
    ...
    public static int Calc(double len) {
        ...
        int offset = (int) (len - LEN_STEP * index);
        ...
        r = Clip(GammaCorrect_sRGB(r))*255;
        g = Clip(GammaCorrect_sRGB(g))*255;
        b = Clip(GammaCorrect_sRGB(b))*255;

        int color = (byte)b;
        color &= 0xff;
        color |= ((long)((byte)g) << 8);
        color &= 0xffff;
        color |= ((long) ((byte)r) << 16);
        color &= 0xffffff;
        color |= ((long) ((byte)0xff) << 24);
